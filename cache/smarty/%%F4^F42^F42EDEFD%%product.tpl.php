<?php /* Smarty version 2.6.10, created on 2015-12-17 19:13:46
...
Product/NoResult.png" />
    ...
    <div id="result" data-cid="1" data-bid="1" data-keyword="" data-antutu="">
		<?php $_from = $this->_tpl_vars['prod']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['pro']):
?>
			<a class="product" href="detail.php?pid=<?php echo $this->_tpl_vars['pro']['ProductId']; ?>
