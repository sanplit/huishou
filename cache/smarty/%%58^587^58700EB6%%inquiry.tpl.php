<?php /* Smarty version 2.6.10, created on 2015-08-20 10:21:42
...
Common/common.min.css" />
		        <link rel="stylesheet" href="<?php echo $this->_tpl_vars['cfg']['url']['css']; ?>
Common/jquery.fancybox.min.css" />
		        <link rel="stylesheet" href="<?php echo $this->_tpl_vars['cfg']['url']['css']; ?>
Inquiry/Index.min.css" />
        <title>询价结果</title>
...
Common/common.min.js"></script>
	        <script type="text/javascript" src="<?php echo $this->_tpl_vars['cfg']['url']['js']; ?>
Common/jquery.fancybox.pack.min.js"></script>
	        <script type="text/javascript" src="<?php echo $this->_tpl_vars['cfg']['url']['js']; ?>
Inquiry/Index.min.js"></script>
	        <script type="text/javascript" src="<?php echo $this->_tpl_vars['cfg']['url']['js']; ?>
